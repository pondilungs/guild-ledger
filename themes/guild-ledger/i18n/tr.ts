...
export const tr: GameLocale = {
  ...
  zoneLootCrafts: {
    rat_trap: { name: 'Sıçan Tuzağı', description: 'Kalıcı +%5 altın geliri. 45 parça gerekir.' },
    goblin_pickaxe: { name: 'Goblin Kazması', description: 'Kalıcı +%10 altın geliri. 100 parça. Düşüş oranını artırmaz.' },
    crypt_lantern: { name: 'Mahzen Feneri', description: 'Kalıcı +%8 DPS. 160 parça.' },
    vault_key: { name: 'Kasa Anahtarı', description: 'Kalıcı +%12 görev altını. 240 parça.' },
    infernal_stamp: { name: 'Cehennem Mühürü', description: 'Kalıcı +%10 offline kazanç. 320 parça.' },
    audit_seal: { name: 'Denetim Mührü', description: 'Kalıcı -%4 ölüm şansı. 450 parça.' },
  },
  prestigeShop: {
