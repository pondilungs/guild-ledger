...
export const tr: GameLocale = {
  ...
  ui: {
    ...
    zoneLootWorkshopDesc: 'Bölgelerde nadir düşen parçaları topla. Yeterli birikince kalıcı ekipman üret — prestige sonrası da kalır.',
  ...
  zoneLootCrafts: {
    ...
    goblin_pickaxe: { name: 'Goblin Kazması', description: 'Kalıcı +%8 altın geliri. Düşüş oranını artırmaz.' },
    crypt_lantern: { name: 'Mahzen Feneri', description: 'Kalıcı +%6 DPS.' },
    vault_key: { name: 'Kasa Anahtarı', description: 'Kalıcı +%10 görev altını.' },
    infernal_stamp: { name: 'Cehennem Mühürü', description: 'Kalıcı +%8 offline kazanç.' },
    audit_seal: { name: 'Denetim Mührü', description: 'Kalıcı -%3 ölüm şansı.' },
  },
  prestigeShop: {
