...
export const tr: GameLocale = {
  ...
  ui: {
    ...
    exportSavePrompt: 'Bu kodu kopyala ve sakla:',
    importSavePrompt: 'Kayıt kodunu buraya yapıştır:',
    importSaveSuccess: 'Kayıt başarıyla içe aktarıldı!',
    importSaveError: 'Geçersiz kayıt kodu.',
    unlock: 'Aç',
    select: 'Seç',
    active: 'Aktif',
