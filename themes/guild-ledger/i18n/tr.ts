...
export const tr: GameLocale = {
  ...
  zoneLoot: {
    trap_wire: { name: 'Paslı Tel', description: 'Sıçan Tuzağının mekanizması için toplanır.' },
    iron_shard: { name: 'Demir Parçası', description: 'Goblin Kazması dövmek için toplanır.' },
    tomb_wax: { name: 'Mahzen Mumu', description: 'Mahzen Fenerini yakmak için toplanır.' },
    dragon_fang: { name: 'Ejderha Dişi', description: 'Kasa Anahtarı işlemek için toplanır.' },
    hell_ink: { name: 'Cehennem Mürekkebi', description: 'Cehennem Mühürü basmak için toplanır.' },
    audit_wax: { name: 'Denetim Balmumu', description: 'Denetim Mührünü mühürlemek için toplanır.' },
  },
  zoneLootCrafts: {
    rat_trap: { name: 'Sıçan Tuzağı', description: '45 paslı tel → kalıcı +%5 altın.' },
    goblin_pickaxe: { name: 'Goblin Kazması', description: '100 demir parçası → kalıcı +%10 altın.' },
    crypt_lantern: { name: 'Mahzen Feneri', description: '160 mahzen mumu → kalıcı +%8 DPS.' },
    vault_key: { name: 'Kasa Anahtarı', description: '240 ejderha dişi → kalıcı +%12 görev altını.' },
    infernal_stamp: { name: 'Cehennem Mühürü', description: '320 cehennem mürekkebi → kalıcı +%10 offline.' },
    audit_seal: { name: 'Denetim Mührü', description: '450 denetim balmumu → kalıcı -%4 ölüm.' },
  },
  prestigeShop: {
  ...
  flavor: {
    ...
    lootDropMsg: (lootName, amount, zoneName) =>
      `${zoneName}: Nadir ganimet! +${amount} ${lootName}`,
    lootCraftMsg: (craftName) => `${craftName} üretildi — kalıcı bonus deftere işlendi.`,
