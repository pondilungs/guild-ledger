...
export const en: GameLocale = {
  ...
  ui: {
    ...
    leaderboardTabPrestige100: '50 Rep.',
    prestige100Race: 'First to 50 Reputation',
    prestige100RaceDesc: 'Players who were first to reach 50 lifetime reputation. Earliest at the top.',
    prestige100ReachedAt: 'Reached',
    prestige100Empty: 'No one has hit 50 reputation yet. Be the first!',
  },
  zones: {
