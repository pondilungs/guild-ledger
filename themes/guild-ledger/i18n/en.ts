...
export const en: GameLocale = {
  ...
  ui: {
    ...
    exportSavePrompt: 'Copy this code and keep it safe:',
    importSavePrompt: 'Paste your save code here:',
    importSaveSuccess: 'Save imported successfully!',
    importSaveError: 'Invalid save code.',
    unlock: 'Unlock',
    select: 'Select',
    active: 'Active',
