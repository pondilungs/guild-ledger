...
export const en: GameLocale = {
  ...
  ui: {
    ...
    zoneLootWorkshopDesc: 'Rare shards drop while you farm each zone. Craft permanent gear — survives prestige.',
  ...
  zoneLootCrafts: {
    ...
    goblin_pickaxe: { name: 'Goblin Pickaxe', description: 'Permanent +8% gold income. Does not raise drop rate.' },
    crypt_lantern: { name: 'Crypt Lantern', description: 'Permanent +6% DPS.' },
    vault_key: { name: 'Vault Key', description: 'Permanent +10% quest gold.' },
    infernal_stamp: { name: 'Infernal Stamp', description: 'Permanent +8% offline earnings.' },
    audit_seal: { name: 'Audit Seal', description: 'Permanent -3% death chance.' },
  },
  prestigeShop: {
