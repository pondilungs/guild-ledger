...
export const en: GameLocale = {
  ...
  ui: {
    ...
    leaderboardTabPrestige100: '40 Rep.',
    prestige100Race: 'First to 40 Reputation',
    prestige100RaceDesc: 'Players who were first to reach 40 lifetime reputation. Earliest at the top.',
    prestige100ReachedAt: 'Reached',
    prestige100Empty: 'No one has hit 40 reputation yet. Be the first!',
  },
  zones: {
