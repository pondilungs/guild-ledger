...
export const en: GameLocale = {
  ...
  zoneLootCrafts: {
    rat_trap: { name: 'Rat Trap', description: 'Permanent +5% gold income. Requires 45 shards.' },
    goblin_pickaxe: { name: 'Goblin Pickaxe', description: 'Permanent +10% gold income. 100 shards. Does not raise drop rate.' },
    crypt_lantern: { name: 'Crypt Lantern', description: 'Permanent +8% DPS. 160 shards.' },
    vault_key: { name: 'Vault Key', description: 'Permanent +12% quest gold. 240 shards.' },
    infernal_stamp: { name: 'Infernal Stamp', description: 'Permanent +10% offline earnings. 320 shards.' },
    audit_seal: { name: 'Audit Seal', description: 'Permanent -4% death chance. 450 shards.' },
  },
  prestigeShop: {
